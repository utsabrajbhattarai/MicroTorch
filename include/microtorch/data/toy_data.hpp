...
Eigen::MatrixXd make_spiral(int n, double noise = 0.0005);
...
Eigen::MatrixXd make_concentric_circles(int n, double noise = 0.0005);
Eigen::MatrixXd make_infinity(int n, double noise = 0.05);
Eigen::MatrixXd make_light_spiral(int n, double noise = 0.05);
} 